...
export const clientDiagnosesTable = pgTable(
  "client_diagnoses",
  {
    id: uuid("id")
      .primaryKey()
...
export const clientCheckinsTable = pgTable(
  "client_checkins",
  {
    id: uuid("id")
      .primaryKey()
...
export const clientBalanceSummariesTable = pgTable(
...
export const eligibilityChecksTable = pgTable(
  "eligibility_checks",
  {
    ...
    insurancePolicyId: uuid(
      ...
      () => clientInsurancePoliciesTable.id,
    ),
...
export const eligibilityBenefitsTable = pgTable(
  "eligibility_benefits",
  {
    ...
    eligibilityCheckId: uuid(
      ...
      .notNull()
      .references(() => eligibilityChecksTable.id, {
        onDelete: "cascade",
      }),
    ...
    copayCents: bigint("copay_cents", {
      mode: "number",
    }),

    coinsurancePercent: numeric(
      "coinsurance_percent",
    ),

    deductibleRemainingCents: bigint(
...
export const authorizationUnitsTable = pgTable(
  "authorization_units",
  {
    id: uuid("id")
      .primaryKey()
    ...
    authorizationId: uuid(
      ...
      .notNull()
      .references(() => authorizationsTable.id, {
        onDelete: "cascade",
      }),
...
export type ClientDiagnosis =
  typeof clientDiagnosesTable.$inferSelect;

export type ClientCheckin =
  typeof clientCheckinsTable.$inferSelect;

export type ClientBalanceSummary =
  typeof clientBalanceSummariesTable.$inferSelect;

export type EligibilityCheck =
  typeof eligibilityChecksTable.$inferSelect;

export type EligibilityBenefit =
  typeof eligibilityBenefitsTable.$inferSelect;

export type Authorization =
  typeof authorizationsTable.$inferSelect;

export type AuthorizationUnit =
  typeof authorizationUnitsTable.$inferSelect;

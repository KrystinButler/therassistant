...
export const professionalClaimsTable = pgTable("professional_claims", {
  ...
  chargeId: uuid("charge_id")
    .references(() => chargeCaptureItemsTable.id),
...
export const professionalClaimLinesTable = pgTable(
...
export const claimDiagnosesTable = pgTable("claim_diagnoses", {
  ...
  pointerOrder: integer("pointer_order")
    .notNull()
    .default(1),
...
export const claimBalanceSummariesTable = pgTable(
  "claim_balance_summaries",
  {
    ...
    openBalanceCents: integer("open_balance_cents")
      .notNull()
      .default(0),
...
export const denialsTable = pgTable("denials", {
  ...
  denialStatus: text("denial_status")
    .notNull()
    .default("open"),

  denialCategory: text("denial_category"),

  workability: text("workability"),
...
export type ProfessionalClaim =
  typeof professionalClaimsTable.$inferSelect;

export type NewProfessionalClaim =
  typeof professionalClaimsTable.$inferInsert;

export type ProfessionalClaimLine =
  typeof professionalClaimLinesTable.$inferSelect;

export type NewProfessionalClaimLine =
  typeof professionalClaimLinesTable.$inferInsert;

export type ClaimDiagnosis =
  typeof claimDiagnosesTable.$inferSelect;

export type ClaimNote =
  typeof claimNotesTable.$inferSelect;

export type ClaimStatusHistory =
  typeof claimStatusHistoryTable.$inferSelect;

export type ClaimBalanceSummary =
  typeof claimBalanceSummariesTable.$inferSelect;

export type Denial =
  typeof denialsTable.$inferSelect;

export type NewDenial =
  typeof denialsTable.$inferInsert;

export type Appeal =
  typeof appealsTable.$inferSelect;

export type NewAppeal =
  typeof appealsTable.$inferInsert;

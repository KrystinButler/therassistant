...
revoke all on function public.create_patient_intake(uuid, jsonb, jsonb, jsonb, jsonb, boolean) from public, anon, authenticated;
grant execute on function public.create_patient_intake(uuid, jsonb, jsonb, jsonb, jsonb, boolean) to authenticated;

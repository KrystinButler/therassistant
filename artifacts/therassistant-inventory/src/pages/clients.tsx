    ...
    >
      ...
      {form.id ? <div className="thera-form-grid">
        ...
        {form.billing_type === "self_pay" && <section className="thera-card">
          <div className="thera-card-header"><div><h2>Self-Pay Billing</h2><p>No insurance policy is required. Payer eligibility, authorization, and enrollment checks will not block the encounter.</p></div></div>

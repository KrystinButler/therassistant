...
export type CrmPayment = { id:string; created_at:string; amount_cents:number; square_status:string; receipt_url:string|null; card_brand:string|null; card_last4:string|null; operator_email:string; crm_account_id?:string|null; square_environment?:"sandbox"|"production" };

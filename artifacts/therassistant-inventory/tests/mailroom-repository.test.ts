...
const input = {
  ...
  clients: [
    { id: "client-1", first_name: "Jordan", last_name: "Ellis" },
  ],
  providers: [
    { id: "provider-1", first_name: "Samantha", last_name: "Thomas", credentials: "LCSW" },
  ],
  payers: [
    { id: "payer-1", name: "Aetna" },
  ],
  claims: [
    { id: "claim-1", client_id: "client-1", payer_id: "payer-1", patient_control_number: "DEMO-001", payer_claim_number: "AETNA-42" },
  ],
  authorizations: [
    { id: "auth-1", client_id: "client-1", payer_id: "payer-1", authorization_number: "AUTH-9", status: "approved" },
  ],
  appeals: [
    { id: "appeal-1", claim_id: "claim-1", appeal_level: "first", appeal_status: "submitted" },
  ],
  documents: [
    { id: "doc-1", file_name: "records-request.pdf", document_type: "payer_correspondence", document_status: "uploaded", storage_path: "demo/tenant-1/mailroom/mail-1/records-request.pdf" },
  ],
  statusHistory: [
  ...
  assignees: [
    { user_id: "user-1", display_label: "Alex Morgan" },
  ],
  today,
};

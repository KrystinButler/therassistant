...
test("manual payment and reversal both resynchronize linked claim status", () => {
  ...
  assert.ok(syncCalls.length >= 3, "expected helper definition plus payment and reversal synchronization calls");
});
